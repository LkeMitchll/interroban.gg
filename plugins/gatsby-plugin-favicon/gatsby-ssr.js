...
exports.onRenderBody = function (_ref) {
  ...
  _ref2$icons = _ref2$icons === undefined ? {} : _ref2$icons;
  var _ref2$icons$android = _ref2$icons.android,
  ...
  if (injectHTML) {
    var prefix = typeof __PREFIX_PATHS__ !== 'undefined' && __PREFIX_PATHS__ ? __PATH_PREFIX__ : '';
    var HeadComponents = [];
